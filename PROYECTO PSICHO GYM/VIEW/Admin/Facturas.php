            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    if (isset($_POST['buscar'])) {
                        ...
                        $query = 'SELECT Factura.ID_Factura as ID_Factura,Factura.ID_Cliente, Usuario.Nombre AS Nombre_Cliente, Factura.Fecha, Factura.Subtotal,
                         Factura.Medio_Pago, Factura.Dirección_Envio  from Factura join Usuario on  Factura.ID_Cliente = Usuario.ID_Cliente where ID_Factura LIKE :dato or Factura.ID_Cliente LIKE :dato
                         or  Usuario.Nombre LIKE :dato or Fecha LIKE :dato or Subtotal LIKE :dato or Medio_Pago LIKE :dato 
                         or Dirección_Envio LIKE :dato';
                        ...
                        from Factura join Usuario on     Factura.ID_Cliente = Usuario.ID_Cliente';
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="editar/DetalleDeVenta.php?id=<?= $Datos->ID_Factura ?>" class="btn btn-small btn-success"><i class="fa-solid fa-magnifying-glass"></i></a>
                            </td>
